...
export default function About() {
  return (
    <Layout>
      ...
      <p>
        <b>raushang4</b>, established in 2019, has been at the forefront of
      ...
      <div className="about-container" id="scott-grivner">
        ...
        <div className="description-container">
          ...
          <div className="social-links">
            ...
            <a href="https://goodreads.com/" target="_blank" rel="noreferrer">
              <Icon name="Goodreads" />
            </a>
            <a
            ...
            <a
              href="https://www.buymeacoffee.com/raushang4"
              target="_blank"
              rel="noreferrer"
            >
              <Icon name="BMC" />
      ...
      <p>
        ...
        <b>raushang4</b>. We tend to keep our team small and follow a{" "}
        <a
          className="regular-link"
