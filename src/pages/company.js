...
export default function Company() {
  return (
    <Layout>
      ...
      <p>
        At <strong>raushang4 Labs</strong>, we're more than just a software
      ...
      <h2>Our History</h2>
      <p>
        <b>raushang4 Labs</b> was founded in 2014 by Scott Grivner and Daniel Volovic. Devin Olshefski was brought on as a partner in 2016.
      ...
      <blockquote className="block-quote">
        <p>
          ...
          <br />
          <br />
          -Raushan kumar, Founder and CEO of raushang4 Labs.
        </p>
      </blockquote>
      <hr />
      <p>
