...
export default function Products() {
  ...
  return (
    <Layout>
      ...
      <p>
        <b>raushang4 Labs</b> takes immense pride in creating innovative
        ...
        <div className="content">
          ...
          {selectedSection === "open-source" && (
            <div className="product-section">
              ...
              <p>
                Community is integral to our ethos. At <b>raushang4 Labs</b>, we
          ...
          {selectedSection === "content" && (
            <div className="product-section">
              ...
              <p>
                <b>At raushang4 Labs</b>, we're always looking forward to
